...
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<ErrorDetails> handleAllException(Exception ex, WebRequest request) {
        ...
        if (!constraintViolations.isEmpty()) {
            ...
            ErrorDetails errorDetails = new ErrorDetails(LocalDateTime.now(), violation.getMessage(), request.getDescription(false));
    ...
    public final ResponseEntity<ErrorDetails> handleArgumentTypeMismatchException(Exception ex, WebRequest request) {
